...
public final class CommandFactory {
	...
	public enum Command {
		USERS_MOVE, START_GAME, HELP, UNKNOWN_COMMAND, START_APPLICATION, EXIT_APPLICATION, HINT;
	}

	private Map<Command, ConsoleCommand> commands = new HashMap<CommandFactory.Command, ConsoleCommand>();

	public CommandFactory(final GameService gameService, final ConsoleBoardService consoleBoardService,
